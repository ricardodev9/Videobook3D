	...
	<header class="headerContent">
		<nav class="navContent">
			<ul>
                ...
                <li>DESPLEGABLE CON OPCIONES DE PELICULA,SERIE O LIBRO</li>
                <li>DESPLEGABLE CON OPCION DE ORDEN</li>
                <li>ELIMINAR FILTROS X</li>
                <li>FOTO DE PERFIL CON DESPLEGABLE</li>
